...
class Test_storagestats_parse_args_Uses_Common_Functions(TestCase):
...
class Test_storagestats_validate_options_Uses_Common_Functions(TestCase):
    ...
    def test_will_call_common_validate_options_and_args(self, mock_func):
        ...
        storagestats_validate_options_and_args()
        self.assertTrue(mock_func.called)
